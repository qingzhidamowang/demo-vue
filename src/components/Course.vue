  ...
  <div id="course" v-loading.fullscreen.lock="load"
    ...
    <div>
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item to="/course">课程列表</el-breadcrumb-item>
      ...
      <el-row>
        <el-col :span="16" class="detail-left">
          ...
          <div class="detail-pic"
            :style="{background: ' url(' + require('../assets/images/course/c1.jpg') + ')'}"
          >
            <!-- 上层蓝色前景色div -->
            <div class="blue-bg">
            <!-- 内容布局div -->
        ...
        <el-col :span="8">
          ...
          <div class="detail-right">
            ...
            <div class="detail-info">
              <!-- 报名按钮 -->
              <div>
                <el-button type="info" disabled v-if="getUsername.account == null||getUsername.account=='' " ><!----><!---->
                  <span>用户已退出</span>
                </el-button>
                <!--  0:立即报名, 1:查看订单, 2:课程售罄, 3:已结束  -->
                <el-button id="book-btn" type="info" v-else-if="showButtonType == 0"
                        ref="book" :class="isBookButtonDisabled ? '' : 'el-button--primary'" :disabled="isBookButtonDisabled"
                        @click="book">
                  <span>立即报名</span>
                </el-button>
                <router-link to="/order"><el-button type="info" v-if="showButtonType == 1" class="el-button--primary" id="trun-btn" >
                  <span>查看订单</span>
